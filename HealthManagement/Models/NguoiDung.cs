...
namespace HealthManagement.Models
{
    ...
    public class NguoiDung
    {
        ...
        public virtual ICollection<KeHoachAnUong> KeHoachAnUong { get; set; } = new List<KeHoachAnUong>();
        public virtual ICollection<DuDoanAI> DuDoanAI { get; set; } = new List<DuDoanAI>();
        public virtual ICollection<LichSuChatBot> LichSuChatBot { get; set; } = new List<LichSuChatBot>();
